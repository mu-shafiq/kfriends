          ...
          child: Column(
            ...
            children: [
                  ...
                  Positioned(
                    ...
                    child: Wrap(
                      ...
                      children: user.interests == null
                          ? []
                          : user.interests!.map((e) => interest(e)).toList(),
                    ),
                  )
                ],
              ),
              ...
              Row(
                ...
                children: [
                  Text(
                    GetUtils.capitalizeFirst(user.nickname)!,
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      color: textBlackColor,
                      fontSize: 16.sp,
              ...
              Row(
                ...
                children: [
                  RoundedSmallButton(
                    ...
                    selected: controller.myFollowing.contains(user.id),
                    onTap: () async {
                      if (controller.myFollowing.contains(user.id)) {
                        await controller.unFollowUser(user.id!);
                      } else {
                        await controller.followUser(user.id!);
                      }
                      controller.update();
                    },
                  ...
                  RoundedSmallButton(
                    ...
                    onTap: () {
                      Get.find<ChatController>().setSelectedUser(
                        user,isNew: true
                      );
