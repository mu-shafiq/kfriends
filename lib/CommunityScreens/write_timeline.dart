...
class WriteTimeLine extends StatelessWidget {
  WriteTimeLine({super.key});
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Container(
                        ...
                        child: ListView.builder(
                            ...
                            itemCount:
                                thinkingController.filesToBeUploaded.length,
                            shrinkWrap: true,
                        ...
                        child: Stack(
                          children: [
                            Positioned(
                              ...
                              child: GestureDetector(
                                onTap: () async {
                                  File? file = await thinkingController
                                      .imagePickerDialog();
                                  file != null
                                      ? thinkingController.updateFile(file)
                                      : null;
                                },
                                child: Container(
                                  width: 65.h,
                  ...
                  CustomTextfield(
                      ...
                      hintSize: 10.sp,
                      controller: thinkingController.contentController),
                  30.verticalSpace,
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    children: [
                      RoundedButton(
                        onTap: () {
                          String alert = '';
                          thinkingController.contentController.text.isEmpty
                              ? alert += 'Enter content..'
                              : null;
                          thinkingController.filesToBeUploaded.isEmpty
                              ? alert += '\nAdd atleat one image'
                              : null;
                          ...
                          alert.isNotEmpty
                              ...
                              : thinkingController.addAThinking();
                        },
                        textColor: textWhiteColor,
                        bgColor: buttonBlueColor2,
                        shadow1: buttonBlackShadow1,
